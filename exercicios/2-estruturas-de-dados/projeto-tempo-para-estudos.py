...
print(f'Olá {nome}, você costuma estudar {total_dias} por semana, durante mais ou menos {total_horas} diárias. Isso significa que você estuda em média {total_horas*total_dias} horas por semana para o curso {curso}.')
